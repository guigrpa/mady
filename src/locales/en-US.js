...
return {
  "someContext_{NUM, plural, one{1 hamburger} other{# hamburgers}}": function(d) { return plural(d.NUM, 0, en_US, { one: "1 hamburger", other: number(d.NUM, "NUM") + " hamburgers" }); },
  "someContext_Hello, {NAME}!": function(d) { return "Hello, " + d.NAME + "!"; },
  "someContext_Hello {NAME}, you have {UNREAD_COUNT, number} {UNREAD_COUNT, plural, one {message} other {messages}}": function(d) { return "Hello " + d.NAME + ", you have " + fmt.number(d.UNREAD_COUNT, "en-US") + " " + plural(d.UNREAD_COUNT, 0, en_US, { one: "message", other: "messages" }); },
