...
const WEBPACK_OPTIONS =
  '--config ./src/server/webpackConfig.cjs ' +
  '--progress ' +
  // '--display-modules ' +
  '--display-chunks';
...
const specs = {
  ...
  scripts: {
    ...
    'compile:relay':
      'relay-compiler --src ./src --schema ./src/common/gqlSchema.graphql',
    'compile:relayWatch':
      'relay-compiler --src ./src --schema ./src/common/gqlSchema.graphql --watch',
    ...
    travis: runMultiple(['npm run compile', 'npm run testCovFullExceptMin']),
